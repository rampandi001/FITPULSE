    ...
    <div className="app-shell">
      ...
      <main className="dashboard-main">
        ...
        <header className="dashboard-header">
          <div>
            <h1>MONDAY, SEPT 14</h1>
            <p>Keep the biological load high today, Marcus.</p>
          </div>
        ...
        <section className="metric-grid">
          ...
          <div className="metric-card">
            <span>Avg Active Heart Rate</span>
        ...
        <section className="dashboard-grid">
          ...
          <div className="dashboard-card metabolic-card">
            ...
            <div className="metabolic-heading">
              ...
              <h2>TODAY'S METABOLIC FOCUS</h2>

              <span>RPE Target: 8.5</span>
